...
cp "$REPO_ROOT/icons/Coda_logo.png" "$PKG_STAGING/usr/share/icons/hicolor/256x256/apps/coda-music.png"
...
cp "$REPO_ROOT/icons/Coda_logo.png" "$APPDIR/usr/share/icons/hicolor/256x256/apps/coda-music.png"
cp "$REPO_ROOT/icons/Coda_logo.png" "$APPDIR/coda-music.png"
...
if command -v dpkg-deb &>/dev/null; then
  ...
  cp "$REPO_ROOT/icons/Coda_logo.png" "$PKG/usr/share/icons/hicolor/256x256/apps/coda-music.png"
